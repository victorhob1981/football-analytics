...
def _api_get_statistics(session: requests.Session, base_url: str, api_key: str, fixture_id: int):
...
def ingest_statistics_bronze():
    ...
    sleep_seconds = float(os.getenv("APIFOOTBALL_STATISTICS_SLEEP_SECONDS", "0.35"))
