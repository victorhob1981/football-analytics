...
def load_statistics_silver_to_postgres():
    ...
    with StepMetrics(
        service="airflow",
        module="silver_to_postgres_statistics",
        step="load_statistics_silver_to_postgres",
        context=context,
    ...
    log_event(
        ...
        message=(
            f"Load statistics concluido | run={run_id} | inseridas={inserted} | atualizadas={updated} | "
